...
%             obj.p = simiam.util.Plotter();
        ...
        function outputs = execute(obj, robot, state_estimate, inputs, dt)
            ...
            if(~obj.calibrated)
                ...
                obj.v_tp = plot(robot.parent, [0;0],[0;0],'g-', 'LineWidth', 2);
                obj.v_pp = plot(robot.parent, [0;0],[0;0],'k-', 'LineWidth', 2);                
                obj.v_fw = plot(robot.parent, [0;0],[0;0],'y-', 'LineWidth', 2);
                set(obj.v_tp, 'ZData', [2;2]);
                set(obj.v_pp, 'ZData', [2;2]);
                set(obj.v_fw, 'ZData', [2;2]);
...
%             set(obj.v_t, 'XData', [u_fw_t(1)+p_1(1);p_1(1)]);%red
%             set(obj.v_t, 'YData', [u_fw_t(2)+p_1(2);p_1(2)]);
%             set(obj.v_p, 'XData', [u_fw_p(1)+x;x]);%blue
%             set(obj.v_p, 'YData', [u_fw_p(2)+y;y]);
            
%             set(obj.v_tp, 'XData', [u_fw_tp(1)+x;x]);%green tangent wall
%             set(obj.v_tp, 'YData', [u_fw_tp(2)+y;y]);
%             set(obj.v_pp, 'XData', [u_fw_pp(1)+x;x]);%black perpend wall
%             set(obj.v_pp, 'YData', [u_fw_pp(2)+y;y]);
%             set(obj.v_fw, 'XData', [u_fw(1)+x;x]);%yellow direction
%             set(obj.v_fw, 'YData', [u_fw(2)+y;y]);
